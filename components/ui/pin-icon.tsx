export default function PinIcon({ colour, className }: { colour: string; className: string }) {
  return (
    <svg display='block' height='41px' width='27px' viewBox='0 0 27 41' className={className}>
      <defs>
